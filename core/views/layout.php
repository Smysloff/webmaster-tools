    ...
    <div class="grid">
                ...
                <form name="tool-selector" class="aside__list tool-selector">
                    ...
                    <div class="aside__item">
                        <label class="disabled">
                            <input type="radio" name="tool" value="site-info" class="tool-item" disabled>
                    ...
                    <div class="aside__item">
                        <label class="disabled">
                            <input type="radio" name="tool" value="serp-simulator" class="tool-item" disabled>
                            <span>SERP-симуляция</span>
                        <label>
                    </div>
                </form>
        ...
        <main class="main">
                ...
                <form class="form">
                    ...
                    <div class="form__item form__item-input">
                        ...
                        <div class="form__description text-analyzer-input-description" hidden>
                            <p>Инструмент позволяет проанализировать тексты на количество символов с пробелами и без, а так же узнать количество слов. Можно работать с текстами больших объемов. Данный инструмент полезен для копирайтеров и для проверки их работы.</p>
                            <p>Просто вставьте нужный текст в окно ввода и нажмите на кнопку "Отправить".</p>
                        </div>
                    </div>
            ...
            <div class="section tool-common-description text-center">
                ...
                <p class="bold">Текущая версия: <?= CURRENT_VERSION ?></p>
            </div>
