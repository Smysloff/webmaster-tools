    ...
    <div class="grid">
                ...
                <form name="tool-selector" class="aside__list tool-selector">
                    ...
                    <div class="aside__item">
                        <label class="disabled">
                            <input type="radio" name="tool" value="sitemap" class="tool-item" disabled>
        ...
        <main class="main">
                ...
                <form class="form">
                    ...
                    <div class="form__item form__item-input">
                        ...
                        <div class="form__description response-code-input-description" hidden>
                            <p>Этот инструмент поможет вам пакетно проверить доступность страниц из вашего списка, а так же наличие редиректа при обращении к ним. Отправка запросов на сторонний сервер требует времени, поэтому результат иногда нужно подождать. Максимальное число адресов за 1 раз - <?= TOOLS_ROWS_LIMIT ?>, остальные будут проигнорированы.</p>
                        ...
                        <div class="form__description tag-parser-input-description" hidden>
                            <p>При помощи данного инструмента вы можете спарсить содержимое нужных вам тегов по заданному списку страниц. Максимальное число страниц за 1 запрос - <?= TOOLS_ROWS_LIMIT ?>, остальные будут проигнорированы.</p>
                        ...
                        <div class="form__description transliter-input-description" hidden>
                            <p>Инструмент позволяет транслитерировать кирилические строки в URL-адреса, в строгом соответствии рекомендациям Яндекса. Максимальное число строк на 1 операцию - <?= TOOLS_ROWS_LIMIT ?>, остальные будут проигнорированы.</p>
                        ...
                        <div class="form__description decoder-input-description" hidden>
                            <p>Инструмент позволяет кодировать (шифровать) и декодировать(расшифровывать) строки согласно выбранным технологиям. Максимальное число строк на 1 операцию - <?= TOOLS_ROWS_LIMIT ?>, остальные будут проигнорированы.</p>
                            <p>Текст необходимо добавлять единым списком, где каждый элемент расположен на новой строке.</p>
                        </div>
                    </div>
            ...
            <div class="section tool-common-description text-center">
                ...
                <p class="bold">Текущая версия: 0.200401</p>
            </div>
